...
-- Volcando datos para la tabla hostcenter.categoria: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla hostcenter.producto: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla hostcenter.usuarios: ~2 rows (aproximadamente)
...
INSERT INTO `usuarios` (`usuario_id`, `tipo_usuario_id`, `codigo`, `usuario`, `nombres`, `clave`, `estado`) VALUES
	...
	(3, 2, '0002', 'admin', 'Administrador', '$2b$10$nbmqWn3zf0tW7b8X6eewIOSLE.9FZ4ass6R2AwVaP6zcwx6fA04om', 'A');
