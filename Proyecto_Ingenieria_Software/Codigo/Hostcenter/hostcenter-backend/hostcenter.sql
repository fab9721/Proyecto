...
INSERT INTO `persona` (`persona_id`, `tipo_identificacion`, `identificacion`, `nombres`, `apellidos`, `direccion`, `telefono`, `email`, `fecha_nacimiento`, `esCliente`, `esProveedor`, `estado`) VALUES
	(1, 'C', '0930764006001', 'JORDAN VICENTE', 'ORDOÑEZ CABRERA', 'VACAS GALINDO', '096159073', 'jordanvicente_21@hotmail.com', '1994-05-21', 1, 0, 'A'),
	(2, 'C', '0919381665', 'JOSELINE VANESSA', 'FLORES SOLIS', 'VACAS GALINDO', '0990013421', 'vanessa.flores1605@gmail.com', '1995-05-16', 1, 0, 'A');
